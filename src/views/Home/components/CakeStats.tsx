    ...
    <StyledCakeStats>
      <CardBody>
        <Heading size="xl" mb="24px">
          {TranslateString(534, 'Boba Stats')}
        </Heading>
        <Row>
          <Text fontSize="14px">{TranslateString(536, 'Total BOBA Supply')}</Text>
        ...
        <Row>
          <Text fontSize="14px">{TranslateString(538, 'Total BOBA Burned')}</Text>
